...
const AlbumCard = (props: AlbumCardProps) => {
    ...
    return (
        <div onClick={() => nav({ to: '/library/albums/$albumId', params: { albumId: props.album.uuid } })} class="flex gap-3 sm:flex-col cursor-pointer">
            <img class="w-20 h-20 sm:w-52 sm:h-52 rounded-md overflow-hidden bg-slate-200 bg-opacity-15" src={api.forTrackCover(props.album.uuid)} alt="" />
            <div>
