...
const AlbumCard = (props: AlbumCardProps) => {
    ...
    return ( 
        <div onClick={() => nav({to: '/library/albums/$albumId', params: {albumId: props.album.uuid}})} class="flex flex-col cursor-pointer">
            <img class="w-52 h-52 rounded-md overflow-hidden bg-slate-200 bg-opacity-15" src={api.urlForTrackCoverById({id: props.album.uuid})} alt="" />
