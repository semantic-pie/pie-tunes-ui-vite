...
const BubblePlayer = () => {
    ...
    return (
        <div class={`flex-col-reverse sm:w-[840px] h-[11rem] sm:h-[90px] flex sm:flex-row sm:gap-0 gap-5 sm:mx-auto sm:items-center justify-between p-4 bubble-player backdrop-blur-[60px] bg-white bg-opacity-15 rounded-[28px] sm:rounded-full`}>
