    ...
    return (
        <div class='flex flex-col gap-8 m-auto px-9 py-12 h-[490px] w-[910px] bg-black bg-opacity-10 authform backdrop-blur-[60px] rounded-[45px] z-10'>
            <div class='flex items-center'>
                ...
                <span class={`ml-auto text-red-500 opacity-0 ${error ? 'opacity-100' : ''} transition-all duration-150 ease-in`}>{error}</span>
            </div>
            ...
            <div class='flex justify-between text-[23px]'>
                <div class='flex flex-col gap-5 min-w-[450px] '>
                    ...
                    <input value={password.value} onInput={(e) => password.value = e.currentTarget.value} class='placeholder-opacity-60 w-full px-[20px] bg-black bg-opacity-10 h-[60px] authinput rounded-full' placeholder='Password' type="password" />
                    <input value={confirmPassword.value} onInput={(e) => confirmPassword.value = e.currentTarget.value} class=' w-full px-[20px] bg-black bg-opacity-10 h-[60px] authinput rounded-full' placeholder='Confirm Password' type="password" />
                </div>
