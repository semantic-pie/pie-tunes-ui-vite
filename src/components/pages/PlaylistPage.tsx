...
const calcGenres = (playlist: Playlist) => {
  ...
  return <div class='flex items-center gap-1.5 opacity-80'><span class='capitalize'>{first},</span><span class='capitalize'>{second}</span>and<span class='capitalize'>{third}</span></div>
}
      ...
      <div class={`flex flex-col gap-5 overflow-y-scroll sm:overflow-hidden`}>
        <div class='p-1 sm:p-5 gap-5 flex flex-col sm:flex-row justify-between'>
          ...
          <div class='flex flex-col w-full  justify-between'>
            <h3 class="text-[18px]">Playlist</h3>
